defmodule R2Web.UserSettingsControllerTest do
  ...
  describe "PUT /users/settings/update_password" do
    ...
    test "does not update password on invalid data", %{conn: conn} do
      old_password_conn =
        put(conn, Routes.user_settings_path(conn, :update_password), %{
          "current_password" => "Your password is not valid",
          "user" => %{
            "password" => "short",
      ...
      assert response =~ "Password should be a min of 6 characters and max of 80 characters"
