defmodule R2Web.UserSettingsController do
  ...
  def edit(conn, _params) do
    render(conn, "edit.html", salutations: B2.Data.ReferenceData.get("salutations"))
  end
    ...
    case Accounts.apply_user_email(user, password, user_params) do
      {:ok, applied_user} ->
        ...
        |> redirect(
          ...
          salutations: B2.Data.ReferenceData.get("salutations")
        )
